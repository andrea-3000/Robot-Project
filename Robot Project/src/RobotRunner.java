...
public class RobotRunner {
    ...
    private static final double WAIT_TIME = .55;
    private static final String MAZE_FILE ="maze9a.dat";
        ...
        while (chosenOption != 4) {
            ...
            switch (chosenOption) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    // User chose option 3. Run a new MemoryRobot.
                    factor = 1;
    ...
    private static int displayMenu (Scanner in) {
        ...
        System.out.println("3. Run MemoryRobot through a maze.");
